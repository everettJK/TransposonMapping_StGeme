...
Sequences were aligned to the representative *Kingella kingae* strain *KWG1*.
...
Transcription units with significant uncorrected p-values are shown in Tables 2 & 3. Gene names followed by 'PRO' represent 
potential promotor regions 1-50 NTs upstream of genes. Full gene tables are available on-line via this [**link**](https://github.com/everettJK/TransposonMapping_StGeme).
